...
public class Vlucht {
     ...
     */
    public static final int AANTALPLAATSEN = 5000;

    /**
     * Reserveringen worden bewaard in een Vector
     */
    private Vector<Integer> reserveringen = new Vector<Integer>();
     ...
     */
    public synchronized int maakReservering(int kantoor) {
    ...
    public Vector<Integer> getReserveringen() {

...
public class VormenFrame extends JFrame {
  ...
  // dat de decimale punt wordt gebruikt ipv de decimale komma
  ...
  private JLabel inhoudLabel = null;
  private JTextField inhoudTextField = null;
  ...
  private void mijnInit() {
    // Voor vormkeuze.values: zie leereenheid 5
  ...
  private void voegtoeAction() {
    ...
    switch (keuze) {
      ...
      case CILINDER:
        ...
        vorm = new Cilinder(straal, hoogte);
        break;
    }
    if (vorm != null) {
      vormen.voegToe(vorm);
      inhoudTextField.setText(formatter.format(vorm.inhoud()));
    }
    afmeting1Veld.setText("");
    afmeting2Veld.setText("");
  ...
  private JPanel getJContentPane() {
    if (jContentPane == null) {
      ...
      totaalLabel.setBounds(new Rectangle(110, 146, 107, 19));
      totaalLabel.setText("Totale inhoud");
      inhoudLabel = new JLabel();
      inhoudLabel.setBounds(new Rectangle(9, 146, 88, 19));
      ...
      jContentPane.add(inhoudLabel, null);
      jContentPane.add(getInhoudTextField(), null);
  ...
  /**
   * This method initializes afmeting1Veld	
   * 	
  ...
  /**
   * This method initializes afmeting2Veld	
   * 	
   * @return javax.swing.JTextField	
   */
  ...
  /**
   * This method initializes inhoudTextField	
   * 	
   * @return javax.swing.JTextField	
   */
  private JTextField getInhoudTextField() {
    if (inhoudTextField == null) {
      inhoudTextField = new JTextField();
      inhoudTextField.setBounds(new Rectangle(9, 182, 88, 19));
      inhoudTextField.setEditable(false);
    }
  ...
  private JTextField getTotaalTextField() {
    if (totaalVeld == null) {
      ...
      totaalVeld.setBounds(new Rectangle(110, 182, 108, 19));
  ...
  /**
   * This method initializes totaalKnop	
   * 	
   * @return javax.swing.JButton	
   */
